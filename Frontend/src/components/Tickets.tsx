...
// //                         <p className="mb-1">📅 Дата отправления: <strong>{formatDate(ticket.date)}</strong></p>
// //                         <p className="mb-1">📅 Дата прибытия: <strong>{formatDate(ticket.date)}</strong></p>
// //                     </div>
// //                     <div className="col-md-6">
...
//     start_date: string; // legacy field, not used
// }
//
// interface PaginatedResponse<T> {
//     page: number;
