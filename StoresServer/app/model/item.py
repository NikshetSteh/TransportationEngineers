...
class PurchaseItem(Base):
    ...
    purchase_id: Mapped[str] = mapped_column(ForeignKey("purchases.id", ondelete="CASCADE"))
    purchase: Mapped["Purchase"] = relationship(back_populates="items")

    store_item_id: Mapped[str] = mapped_column(ForeignKey("store_items.id", ondelete="CASCADE"))
    store_item: Mapped["StoreItem"] = relationship()
    count: Mapped[int] = Column(
        Integer
    )
